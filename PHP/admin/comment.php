...
if (isset($_GET['id'])) {
    ...
    if (isset($_POST['submit'])) {
        // Update the comment
        $stmt = $pdo->prepare('UPDATE comments SET page_id = ?, parent_id = ?, display_name = ?, content = ?, submit_date = ?, votes = ?, img = ?, approved = 1 WHERE id = ?');
        $stmt->execute([ $_POST['page_id'], $_POST['parent_id'], $_POST['display_name'], $_POST['content'], date('Y-m-d H:i:s', strtotime($_POST['submit_date'])), $_POST['votes'], $_POST['img'], $_GET['id'] ]);
    ...
    if (isset($_POST['submit'])) {
        ...
        $stmt->execute([ $_POST['page_id'], $_POST['parent_id'], $_POST['display_name'], $_POST['content'], date('Y-m-d H:i:s', strtotime($_POST['submit_date'])), $_POST['votes'], $_POST['img'], 1, $_POST['acc_id'] ]);
...
<form action="" method="post">
    ...
    <div class="content-title responsive-flex-wrap responsive-pad-bot-3">
        ...
        <?php if ($page == 'Edit'): ?>
        <input type="submit" name="delete" value="Delete" class="btn red mar-right-2" onclick="return confirm('Are you sure you want to delete this post?')">
        <?php endif; ?>
    ...
    <div class="content-block">
        ...
        <div class="form responsive-width-100">
            ...
            <textarea id="content" name="content" placeholder="Write your post..." required><?=htmlspecialchars($comment['content'], ENT_QUOTES)?></textarea>
